...
def fetch_cricket_scores():
    ...
    headers = {
        ...
        "X-RapidAPI-Key": "a4571a784cmsh21a28f08b691292p1a4da2jsna6339ba91f60"  
    }
...
def fetch_upcoming_matches():
    ...
    headers = {
        "X-RapidAPI-Host": "cricbuzz-cricket.p.rapidapi.com",
        "X-RapidAPI-Key": "a4571a784cmsh21a28f08b691292p1a4da2jsna6339ba91f60"  # Replace with your RapidAPI key
    }
    #
    response = requests.get(url, headers=headers)
    upcoming_matches = []
